package nl.sm442.docentgo.webserver.data.dao;

import java.util.List;

/**
 * nl.sm442.docentgo.webserver.data.dao.DAO defines the standard operations that should be available for every specialized nl.sm442.docentgo.webserver.data.dao.DAO.
 *
 * @param <I> The class that is used for identifying the object in the database.
 * @param <T> The class that is managed by this nl.sm442.docentgo.webserver.data.dao.DAO.
