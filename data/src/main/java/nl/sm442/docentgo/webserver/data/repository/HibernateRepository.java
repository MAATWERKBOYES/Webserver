package nl.sm442.docentgo.webserver.data.repository;

import nl.sm442.docentgo.webserver.data.EntityManagerLocator;
...
/**
 * A {@code nl.sm442.docentgo.webserver.data.repository.HibernateRepository} performs default operations, specified in a {@link DAO}, on a database
 ...
 * @param <D> The type of the {@code nl.sm442.docentgo.webserver.data.dao.DAO} that this {@code nl.sm442.docentgo.webserver.data.repository.HibernateRepository} uses.
 * @author Lesley
 */
